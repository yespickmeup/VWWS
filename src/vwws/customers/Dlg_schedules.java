 ...
 * @author Ronescape
 */
public class Dlg_schedules extends javax.swing.JDialog {

    /**
     * Creates new form Dlg_schedules
     */
...
//</editor-fold>
    ...
    private Dlg_schedules(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_schedules(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
        myInit();
    ...
    private Dlg_schedules myRef;

    private void setThisRef(Dlg_schedules myRef) {
        this.myRef = myRef;
    }
    private static java.util.Map<Object, Dlg_schedules> dialogContainer = new java.util.HashMap();
    ...
    public static Dlg_schedules create(java.awt.Window parent, boolean modal) {
    ...
    public static Dlg_schedules create(java.awt.Window parent, java.awt.Dialog.ModalityType modalType) {

        if (parent instanceof java.awt.Frame) {

            Dlg_schedules dialog = dialogContainer.get(parent);

            if (dialog == null) {
                dialog = new Dlg_schedules((java.awt.Frame) parent, false);
        ...
        if (parent instanceof java.awt.Dialog) {
            ...
            if (dialog == null) {
                dialog = new Dlg_schedules((java.awt.Dialog) parent, false);
                dialog.setModalityType(modalType);
                dialogContainer.put(parent, dialog);
                java.util.logging.Logger.getAnonymousLogger().log(Level.INFO, "instances: {0}", dialogContainer.size());
                dialog.setThisRef(dialog);
    ...
    public static void main(String args[]) {
        ...
        Dlg_schedules dialog = Dlg_schedules.create(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Search", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jCheckBox9, javax.swing.GroupLayout.PREFERRED_SIZE, 505, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGap(1, 1, 1)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jCheckBox6, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jTextField7, javax.swing.GroupLayout.PREFERRED_SIZE, 545, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Results", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N
        ...
        jTabbedPane1.addTab("New Applications", jPanel2);
        ...
        jTabbedPane1.addTab("Survey Schedules", jPanel3);
        ...
        jTabbedPane1.addTab("Installation Schedules", jPanel4);
        ...
        jTabbedPane1.addTab("Complaints ", jPanel7);
...
//                btn_0.doClick();
    ...
    private void new_application() {
        Window p = (Window) this;
        Dlg_consumer_application nd = Dlg_consumer_application.create(p, true);
        nd.setTitle("");
//        nd.do_pass(services);
        nd.setCallback(new Dlg_consumer_application.Callback() {

            @Override
            public void ok(CloseDialog closeDialog, Dlg_consumer_application.OutputData data) {
                closeDialog.ok();
