...
public class MyMain {
    ...
    private static void ret_config() {
        String home = System.getProperty("user.home") + "\\my_config_vwws.conf";
        
        try {
            
            Properties prop = new Properties();
            String conf = "my_config_vwws.conf";
...
//            System.out.println(home);
            ...
            System.setProperty("pool_db", prop.getProperty("pool_db", "db_vwws"));
